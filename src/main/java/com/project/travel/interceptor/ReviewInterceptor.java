...
import com.project.travel.tReview.TReviewMapper;
...
public class ReviewInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		tReviewVO.setNum(Long.parseLong(num));
		tReviewVO = tReviewMapper.getDetail(tReviewVO);
		...
		if (tReviewVO.getId().equals(memberVO.getId())) {
			check = true;
