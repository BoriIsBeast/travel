...
<div class="mb-3">
  ...
  <input class="form-control" name="category" id="category" value="${vo.category}" type="text" aria-label="default input example">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">코스명</label>
  <input class="form-control" name="title" id="title" value="${vo.title}" type="text" aria-label="default input example">
</div>
 <div class="mb-3">
