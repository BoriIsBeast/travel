		...
		<form action="./update" method="post" enctype="multipart/form-data">
			<div class="mb-3">
				<input class="form-control" name="num" value="${vo.num}"
					...
					for="exampleFormControlTextarea1" class="form-label">아이디</label> <input
					class="form-control" name="id" type="text" id="id"
				...
				<div class="mb-3">
					...
					<input class="form-control" name="category" id="category"
						value="${vo.category}" type="text"
						aria-label="default input example">
				</div>
				<div class="mb-3">
					<label for="exampleFormControlTextarea1" class="form-label">코스명</label>
					<input class="form-control" name="title" id="title"
						value="${vo.title}" type="text" aria-label="default input example">
				</div>
				<div class="mb-3">
